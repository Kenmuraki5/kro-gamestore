            ...
            >
              ...
              >
                ...
                <div class="mt-4 border-t border-gray-200">
                  <h2 class="text-lg ml-2 my-3 font-medium text-gray-900">
                    Sort Option
                  </h2>
                  <ul
                    role="list"
                  ...
                  >
                    ...
                    >
                      <input
                        ...
                        class="h-4 w-4 ml-3 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                      />
                      <label
                ...
                <div class="mt-4 border-gray-200">
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <label
                        :for="`filter-${option.id}-${optionIdx}`"
                        class="ml-3 text-sm text-gray-600"
                        >{{ option.label }}</label
                      >
                    </div>
            ...
            <div class="hidden lg:block">
              ...
              >
                ...
                <DisclosurePanel class="pt-6">
                  <div class="space-y-4">
                    <div
                      v-for="(option, optionIdx) in price.options"
                      :key="option.value"
                      class="flex items-center"
                    >
                      <input
              ...
              >
                ...
                <DisclosurePanel class="pt-6">
                  <div class="space-y-4">
                    <div
                      v-for="(option, optionIdx) in genre.options"
                      :key="option.value"
                      class="flex items-center"
                    >
                      <input
...
const genre = {
  ...
  options: [
    ...
    { value: "Battle Royal", label: "Battle Royal", checked: false },
...
const filteredGames = computed(() => {
  let filtered = gameStore.games.filter((game) => {
    const categoryMatch =
      selectedBrand.value === "All Game" || game.brand === selectedBrand.value;

    const priceMatch =
      selectedPriceOptions.value.length === 0 ||
      selectedPriceOptions.value.some((option) => {
    ...
    const genreMatch =
      selectedGenreOptions.value.length === 0 ||
      selectedGenreOptions.value.some((option) => {
