        ...
        <div class="profile-content mt-8">
            ...
            <div class="profile-sections bg-gray-100 mt-8">
                ...
                <div class=" address-form section system-settings mt-8 bg-white shadow-md rounded-md p-4">
                    ...
                    <textarea type="text" id="address" v-model="user.address"
                        class="w-full py-2 px-3 rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500 mb-4"
                    ...
                    <select id="district" v-model="user.district"
                        class="w-full py-2 px-3 rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500 mb-4">
                        <option v-for="district in districts.filter(district => district.province_id == user.province.id)"
                    ...
                    <select id="subdistrict" v-model="user.subdistrict"
                        class="w-full py-2 px-3 rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500 mb-4">
                        <option
                            v-for="subdistrict in subdistricts.filter(subdistrict => subdistrict.amphure_id == user.district.id)"
...
var user = ref({
    ...
    address: `${authStore.user.address.address} ${authStore.user.address.subDistrict} ${authStore.user.address.province} ${authStore.user.address.postalCode}`,
})
</script>